...
def get_configuration_list():
    parameter_dict = {
        ...
        'goal_value_init_gamma_threshold': [0.45],

        # oci configs
        'use_oci_target_update': [True],
        'oci_beta': [1.0, 0.5, 0.3, 0.2, 0.1, 1e-3, 1e-5, 1e-7, 0.0],
        ...
        'load_pretrain_goal_values': ['pinball_hard_ddqn_test'],
        'use_pretrained_goal_values_optimization': [True],
        'batch_buffer_add_size': [1024],
        
        # Model training
        'load_model_name': ['pinball_hard_ddqn_test'],
