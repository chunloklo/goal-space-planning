...
def get_configuration_list():
    parameter_dict = {
        ...
        # Logging
        'log_keys': [('reward_rate', 'step_goal_gamma_map')],
        ...
        'model_arch_flag': ['pinball_hard_var3'],
        ...
        # Model training
        # 'pretrained_model_name': ['pinball_hard_all_early'],
        'save_state_to_goal_estimate_name': ['pinball_hard_600k_var3'], # throwaway
