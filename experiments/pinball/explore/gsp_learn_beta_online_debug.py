...
def get_configuration_list():
    parameter_dict = {
        ...
        # 'save_goal_values_name': ['pinball_explore_debug'],
        'use_pretrained_goal_values_optimization': [False],
        'batch_buffer_add_size': [1024],
        
        # Model training
        'load_model_name': ['pinball_explore_online_prefill'],
        # 'save_model_name': ['pinball_explore_debug'],
        ...
        # 'save_behaviour_name': ['pinball_explore_debug'],
