...
def get_configuration_list():
    parameter_dict = {
        ...
        # 'save_goal_values_name': ['pinball_scratch_model_short_fix'],
        # 'load_pretrain_goal_values': ['oracle_goal_values'],
        'use_pretrained_goal_values_optimization': [True],
        'batch_buffer_add_size': [1024],
        
        # Model training
        'load_model_name': ['pinball_scratch_model_short'], # throwaway
        'save_model_name': ['pinball_scratch_model_short_fixed'], # throwaway
