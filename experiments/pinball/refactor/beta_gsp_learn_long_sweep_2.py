...
def get_configuration_list():
    parameter_dict = {
        ...
        'behaviour_alg': ['DQN'],
        'polyak_stepsize': [0.05, 0.1, 0.2, 0.4, 0.8, 1.0],
        'step_size': [1e-4, 5e-4, 1e-3, 5e-3, 1e-2],
        'adam_eps': [1e-8],
        'batch_num': [4],
        'batch_size': [16],
        'epsilon': [0.1],
        ...
        'load_pretrain_goal_values': ['pinball_refactor_more_learning'],
        'use_pretrained_goal_values_optimization': [True],
        'batch_buffer_add_size': [1024],
        
        # Model training
        'load_model_name': ['pinball_refactor_more_learning'],
