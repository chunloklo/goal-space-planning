...
def get_configuration_list():
    parameter_dict = {
        ...
        'load_goal_values_name': ['pinball_scratch_behaviour_175000'],
        'use_pretrained_goal_values_optimization': [True],
        'batch_buffer_add_size': [1024],
        
        # Model training
        'load_model_name': ['pinball_scratch_behaviour_175000'],
        ...
        'load_behaviour_name': ['pinball_scratch_behaviour_175000'],
        'load_buffer_name': ['pinball_scratch_behaviour_175000'],
