...
def get_configuration_list():
    files = [
        'experiments/chunlok/mpi/extended/collective/dyna_backgroundgpi_only_low_init_sweep.py',
        'experiments/chunlok/mpi/extended/collective/dyna_gpi_only_low_init_sweep.py',
        'experiments/chunlok/mpi/extended/collective/dyna_sweep.py',
        'experiments/chunlok/mpi/extended/collective/dynaoptions_sweep.py',
        'experiments/chunlok/mpi/extended/collective/dyna_ourgpi_maxaction.py',
    ]
