...
def create_options(env, option_name):
    ...
    if "IdealGrazing" in option_name:
        ...
        policy_option_1 = {
            ...
            70: UP,    71: LEFT,  72: RIGHT,  73: RIGHT, 74: UP,    75: UP,    76: LEFT,   77: UP,    78: UP  , 79: UP, 
        ...
        save_option('IdealGrazingO1', option1)
        ...
        save_option('IdealGrazingO2', option2)
        ...
        policy_option_3 = {
            ...
            40: RIGHT, 41: RIGHT,  42: RIGHT,  43: RIGHT, 44: RIGHT, 45: RIGHT, 46: DOWN,  47: LEFT,  48: LEFT,  49: LEFT,   
            50: RIGHT, 51: RIGHT,  52: RIGHT,  53: RIGHT, 54: RIGHT, 55: RIGHT, 56: DOWN,  57: LEFT,  58: LEFT,  59: LEFT, 
            60: RIGHT, 61: RIGHT,  62: RIGHT,  63: RIGHT, 64: RIGHT, 65: RIGHT, 66: DOWN,  67: LEFT,  68: LEFT,  69: LEFT,
            70: RIGHT, 71: RIGHT,  72: RIGHT,  73: RIGHT, 74: RIGHT, 75: RIGHT, 76: UP,  77: UP,  78: UP,  79: UP, 
            80: RIGHT, 81: RIGHT,  82: RIGHT,  83: RIGHT, 84: RIGHT, 85: RIGHT, 86: UP,  87: LEFT,  88: LEFT,  89: LEFT,  
            90: RIGHT, 91: RIGHT,  92: RIGHT,  93: RIGHT, 94: RIGHT, 95: RIGHT, 96: UP,  97: LEFT,  98: LEFT,  99: LEFT
        ...
        save_option('IdealGrazingO3', option3)


        # Option 4 lead to the middle of the gridworld

        option_4_term_set = [44]
        ...
        save_option('IdealGrazingO4', option4)
...
if __name__ == '__main__':
    ...
    if sys.argv[1].lower() == "maze":
        env = MazeWorld(0)
        option_name = "Maze0"
    elif sys.argv[1].lower() == "idealgrazing":
        env = GrazingWorld(0)
        option_name = "IdealGrazing"
    elif sys.argv[1].lower() == "graze" or sys.argv[1].lower() == "grazing" or sys.argv[1].lower() == "idealgrazing":
        env = GrazingWorld(0)
